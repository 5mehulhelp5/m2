...
use Webkul\Quotesystem\Model\ResourceModel\Quotes\CollectionFactory;
use Magento\Framework\Pricing\Helper\Data;
use Webkul\Quotesystem\Model\Quotes;
...
class Buyerquotes extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var Webkul\Quoetsystem\Model\Quotes
     */
    ...
    public function getFormattedPrice($price)
    {
        ...
        $amount = $this->helper->getwkconvertCurrency($fromCurrency, $toCurrency, $price);
