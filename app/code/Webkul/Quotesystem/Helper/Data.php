...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @param \Webkul\Quotesystem\Model\QuotesFactory              $quotesFactory
    ...
    public function __construct(
        ...
        \Webkul\Quotesystem\Model\QuotesFactory $quotesFactory,
     ...
     * @param Webkul\Quotesystem\Model\Quotes
     *
     * @return string
     */
    ...
    {
        $auctionModuleEnabledOrNot = $this->checkModuleIsEnabledOrNot('Webkul_Auction');
        $quoteProductsInfo = [];
    ...
    public function getConfigValues()
    {
        ...
        $groupId = 'wk_quotesystemsetting';
        $optionArray = 'wk_quotesystemenabledisable';
    ...
    {
        if ($string!='') {
            $moduleData = $this->moduleList->getOne('Webkul_Quotesystem');
    ...
    {
        return $this->scopeConfig->getValue(
            'quotesystem/wk_quotesystemsetting/discount_enable',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'quotesystem/wk_quotesystemsetting/allowed_type',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getConfigAddToCart()
    {
        if ($this->getModuleStatus()) {
            return $this->scopeConfig->getValue(
                'quotesystem/wk_quotesystemsetting/allowed_add_to_cart',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );
        }
        return false;
    ...
    public function getConfigShowPrice()
    {
        if ($this->getModuleStatus()) {
            return $this->scopeConfig->getValue(
                'quotesystem/wk_quotesystemsetting/allowed_showprice',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );
        }
        return false;
    ...
    {
        return $this->scopeConfig->getValue(
            'quotesystem/wk_quotesystemsetting/wk_quotesystemenabledisable',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getConfigMinQty() : int
    {
        return (int)$this->scopeConfig->getValue(
            'quotesystem/wk_quotesystemsetting/min_quote_qty',
    ...
    public function removeCartItem($id)
    {
        ...
        foreach ($id as $cartItemId) {
            $quoteCollection = $this->getWkQuoteModel()->load($cartItemId);
            if ($quoteCollection->getSize()) {
