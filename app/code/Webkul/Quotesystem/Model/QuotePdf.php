...
class QuotePdf
{
     ...
     * @param \Webkul\Quotesystem\Api\QuoteDetailsRepositoryInterface $quoteDetailRepo
    ...
    public function __construct(
        ...
        \Webkul\Quotesystem\Api\QuoteDetailsRepositoryInterface $quoteDetailRepo,
     ...
     * @param \Zend_Pdf_Font $font
     * @param int $x
     * @param \Webkul\Quotesystem\Model\QuotesFactory $quoteCollection
     * @return void
     */
