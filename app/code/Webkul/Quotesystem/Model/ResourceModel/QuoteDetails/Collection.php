 ...
 */
namespace Webkul\Quotesystem\Model\ResourceModel\QuoteDetails;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\Quotesystem\Model\QuoteDetails ::class,
            \Webkul\Quotesystem\Model\ResourceModel\QuoteDetails ::class
        );
    ...
    public function setTableRecords($ids, $columnData)
    {
        return $this->getConnection()->update(
            $this->getTable('wk_quote_details'),
            $columnData,
            $where = $ids
        );
    }
