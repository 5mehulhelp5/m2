...
namespace Webkul\Quotesystem\Model\ResourceModel\QuoteDetails\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Webkul\Quotesystem\Model\ResourceModel\QuoteDetails\Collection as QuoteCollection;
...
class Collection extends QuoteCollection implements SearchResultInterface
{
    ...
    protected function _initSelect()
    {
        ...
        $joinTable = $this->getTable('wk_quotes');
        $this->getSelect()->join(
            $joinTable.' as qts',
