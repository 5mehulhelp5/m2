 ...
 */
namespace Webkul\Quotesystem\Test\Unit\Controller\Buyerquote;

use Webkul\Quotesystem\Controller\Buyerquote\Savequote;
...
class SavequoteTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var \Webkul\Quotesystem\Api\QuoteRepositoryInterface|\PHPUnit_Framework_MockObject_MockObject */
    ...
    protected function setUp()
    {
        ...
        $this->_sessionMock = $this->getMockBuilder('Magento\Customer\Model\Session')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_quoteRepositoryMock = $this->getMockBuilder('Webkul\Quotesystem\Api\QuoteRepositoryInterface')
            ->getMockForAbstractClass();
        $this->_resultRedirect = $this->getMockBuilder('Magento\Framework\Controller\Result\Redirect')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_quotesFactory = $this->getMockBuilder('Webkul\Quotesystem\Model\QuotesFactory')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_quoteHelper = $this->getMockBuilder('Webkul\Quotesystem\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_quoteMailHelper = $this->getMockBuilder('Webkul\Quotesystem\Helper\Mail')
            ->disableOriginalConstructor()
            ->getMock();
